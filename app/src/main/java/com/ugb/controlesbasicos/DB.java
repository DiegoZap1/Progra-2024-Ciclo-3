...
public class DB extends SQLiteOpenHelper {
    ...
    private static final String SQLdb = "CREATE TABLE amigos(id text, rev text, idAmigo text, " +
            "nombre text, telefono text,dui text, foto text, actualizado text)";
    ...
    public String administrar_amigos(String accion, String[] datos){
        try {
            ...
            if( accion.equals("nuevo") ){
                sql = "INSERT INTO amigos(id,rev,idAmigo,nombre,email,foto,actualizado) VALUES('"+ datos[0] +"','"+ datos[1] +"','"+ datos[2] +"', '"+
                        datos[3] +"', '"+ datos[4] +"','"+ datos[5] +"')";
            } else if (accion.equals("modificar")) {
                sql = "UPDATE amigos SET id='"+ datos[0] +"',rev='"+ datos[1] +"',nombre='"+ datos[3] +"', email='"+ datos[4] +"', foto='"+ datos[5] +"', actualizado=" +
                        "'"+ datos[6] +"'WHERE idAmigo='"+ datos[2] +"'";
